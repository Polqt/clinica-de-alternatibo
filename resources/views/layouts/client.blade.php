...
<body class="min-h-screen bg-white dark:bg-zinc-800">
    <flux:sidebar sticky stashable class="bg-zinc-50 dark:bg-zinc-900 border-r rtl:border-r-0 rtl:border-l border-zinc-200 dark:border-zinc-700">
        ...
        <flux:navlist variant="outline">
            <flux:navlist.item icon="home" href="/user/dashboard" current>Dashboard</flux:navlist.item>
            <flux:navlist.item icon="calendar" href="/">Schedule</flux:navlist.item>
            <flux:navlist.item icon="history" href="/">Medical History</flux:navlist.item>
