...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div class="bg-white dark:bg-slate-800 rounded-lg shadow-sm p-5 border border-slate-200 dark:border-slate-700 transition-all hover:shadow-md">
            ...
            <p class="text-xs text-slate-500 dark:text-slate-400 mt-2">{{ $recentVisits->count() ?? 0 }} visits in the last 90 days</p>
        </div>
        ...
        <div class="bg-white dark:bg-slate-800 rounded-lg shadow-sm p-5 border border-slate-200 dark:border-slate-700 transition-all hover:shadow-md">
            ...
            <div class="mt-4 flex items-center">
                ...
                <span class="text-xs text-slate-700 dark:text-slate-300">Next appointment: {{ $nextAppointment ?? 'None scheduled' }}</span>
            </div>
        </div>
    </div>
