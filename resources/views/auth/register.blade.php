...
<div class="flex min-h-screen items-center justify-center p-6">
    <div class="w-full max-w-md rounded-xl p-8 shadow-lg">
        ...
        <form method="POST" action="{{ route('login') }}" class="space-y-6">
            @csrf
            <div class="grid grid-cols-2 space-x-4 gap-4">
                <div>
                    <x-forms.label for="first_name" class="block text-sm font-medium text-teal-800" required>First Name</x-forms.label>
                    <x-forms.input
                        type="text"
                        name="first_name"
                        id="first_name"
                ...
                <div>
                    <x-forms.label for="last_name" class="block text-sm font-medium text-teal-800" required>Last Name</x-forms.label>
                    <x-forms.input
                        type="text"
                        name="last_name"
                        id="last_name"
            ...
            <div>
                <x-forms.label for="email" class="block text-sm font-medium text-teal-800" required>Email</x-forms.label>
                <x-forms.input
                    type="email"
                    name="email"
                    id="email"
        ...
        <div class="mt-6 text-center">
            <p class="text-sm text-gray-600">
                ...
                <a href="{{ route('login') }}" class="font-medium text-teal-600 hover:text-teal-500 hover:underline transition-colors">Sign in now</a>
            </p>
        </div>
    </div>
</div>
